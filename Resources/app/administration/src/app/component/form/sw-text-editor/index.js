...
Component.register('sw-text-editor', {
        ...
        buttonConfig: {
            ...
            default() {
                return [
                    {
                        type: 'paragraph',
                        title: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.format'),
                        icon: 'regular-style-xs',
                        children: [
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.paragraph'),
                                value: 'p',
                                tag: 'p',
                            },
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.h1'),
                                value: 'h1',
                                tag: 'h1',
                            },
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.h2'),
                                value: 'h2',
                                tag: 'h2',
                            },
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.h3'),
                                value: 'h3',
                                tag: 'h3',
                            },
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.h4'),
                                value: 'h4',
                                tag: 'h4',
                            },
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.h5'),
                                value: 'h5',
                                tag: 'h5',
                            },
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.h6'),
                                value: 'h6',
                                tag: 'h6',
                            },
                            {
                                type: 'formatBlock',
                                name: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.blockquote'),
                                value: 'blockquote',
                                tag: 'blockquote',
                            },
                        ],
                    ...
                    {
                        type: 'foreColor',
                        title: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.text-color'),
                        value: '',
                        tag: 'font',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        title: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.insert-unordered-list'),
                        icon: 'regular-list-unordered-xs',
                        tag: 'ul',
                    },
                    {
                        type: 'insertOrderedList',
                        title: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.insert-ordered-list'),
                    ...
                    {
                        type: 'redo',
                        title: SnapAdmin.Snippet.tc('sw-text-editor-toolbar.title.redo'),
    ...
    data() {
        return {
            ...
            isTableEdit: false,
            cmsPageState: SnapAdmin.State.get('cmsPageState'),
        };
    },
